...
truth_1 = GroundTruthState([-50, 0, 50, 0, 0], timestamp=start_time)
truth_2 = GroundTruthState([-50, 0, -50, 0, 0], timestamp=start_time)
...
ground_truth_simulator = MultiTargetGroundTruthSimulator(
    ...
    preexisting_states=[truth_1.state_vector,
                        truth_2.state_vector],
...
sleep(1) # sleep for 2s to prevent buffer overflow
